...
MAIN_SCRIPT <- "/mnt/spareHD_2/nu_287/q2_parallelism/plot_Figure5_AB_marine_line_visible.R"
...
PANEL_B_SUPP <- PANEL_B +
  ...
  # Redraw the marine references last so they remain visible above all points.
  geom_segment(
    data = B_SUM,
    aes(
      x = x_position - 0.29,
  ...
  labs(
    caption = paste0(
      ...
      " Blue circles and green triangles show Alaska and British Columbia, ",
      "respectively; red outlines identify recently colonized populations. ",
      "Marine reference frequencies are dark-purple dashed lines and established-freshwater ",
      "medians are solid."
    )
  )
