...
erc_dir <- "/mnt/spareHD_2/genomewide_codeml_kuster/10_erc_results/mtPCG_composite_t_spearman"
figure_dir <- "/mnt/spareHD_2/genomewide_codeml_kuster/11_erc_figures/Figure_ERC_Weaver_style"
