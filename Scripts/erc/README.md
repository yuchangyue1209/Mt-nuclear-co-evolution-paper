...
```bash
bash /work/cyu/Kuster2026_genomewide_reanalysis/genomewide_erc/run_erc_server.sh

Rscript /work/cyu/Kuster2026_genomewide_reanalysis/genomewide_erc/R/00_gene_level_screening.R
Rscript /work/cyu/Kuster2026_genomewide_reanalysis/genomewide_erc/R/01_weaver_gene_set_erc.R
Rscript /work/cyu/Kuster2026_genomewide_reanalysis/genomewide_erc/R/02_complex_permutation_and_CIV_robustness.R
Rscript /work/cyu/Kuster2026_genomewide_reanalysis/genomewide_erc/R/03_plot_ERC_main_figure.R
```

Primary results are written to:

`/mnt/spareHD_2/genomewide_codeml_kuster/10_erc_results/mtPCG_composite_t_spearman`

The final figure is written to:

`/mnt/spareHD_2/genomewide_codeml_kuster/11_erc_figures/Figure_ERC_Weaver_style`
