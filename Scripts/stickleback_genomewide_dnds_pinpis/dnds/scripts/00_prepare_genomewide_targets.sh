...
CLASSIFICATION="/work/cyu/Kuster2026_genomewide_reanalysis/stickleback_mapping/stickleback_gene_classification.final.tsv"
GFF3="/work/cyu/oxphos_from_ref_no_biomart/04_gff/stickleback_with_contact.gff3"
REF="/work/cyu/stickleback_nuclear_only.fa"

OUT="/mnt/spareHD_2/genomewide_codeml_kuster/00_targets"
mkdir -p "$OUT"
