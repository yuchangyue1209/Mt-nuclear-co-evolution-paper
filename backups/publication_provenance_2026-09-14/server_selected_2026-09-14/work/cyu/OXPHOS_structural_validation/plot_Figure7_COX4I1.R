...
freq_file <- Sys.getenv(
  "COX4I1_FREQ_FILE",
  "/work/cyu/OXPHOS_structural_validation/287_recalled_nonsyn/nonsynonymous_variant_population_frequencies.tsv"
)
protein_file <- Sys.getenv(
  "COX4I1_PROTEIN_FILE",
  "/work/cyu/cox4i1_coordinate_validation/cox4i1.reference_protein.fa"
)
outdir <- Sys.getenv(
  "COX4I1_FIGURE_DIR",
  "/work/cyu/OXPHOS_structural_validation/cox4i1_Figure7"
)
