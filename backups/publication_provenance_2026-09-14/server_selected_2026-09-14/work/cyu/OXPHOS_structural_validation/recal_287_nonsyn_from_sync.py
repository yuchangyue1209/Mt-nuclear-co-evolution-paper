...
SYNC_DIR = Path("/mnt/spareHD_2/nu_287/sync")
BAMLIST = Path("/mnt/spareHD_2/oxphos_gene_tree/bamlist_nuclear.txt")

GTF = Path("/work/cyu/OXPHOS_structural_validation/287_recalled_nonsyn/canonical_289_loci_from_phase.gtf")

OUTDIR = Path(
    "/work/cyu/OXPHOS_structural_validation/287_recalled_nonsyn"
)
