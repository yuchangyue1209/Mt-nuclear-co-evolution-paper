...
export KUSTER_CODE_ROOT="/path/to/workspace/Kuster2026_genomewide_reanalysis"
export KUSTER_DATA_ROOT="/path/to/data/genomewide_codeml_kuster"
...
export KUSTER_OLD_MT_RESULTS="/path/to/data/oxphos_codeml_ready/09_codeml_sites_models/codeml_sites_summary.merged.tsv"
...
export KUSTER_SYNC="/path/to/workspace/nuclear_withNorway.merged.sync"
export KUSTER_REFERENCE="/path/to/workspace/stickleback_nuclear_only.fa"
