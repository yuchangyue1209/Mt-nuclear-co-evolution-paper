...
# paths
# -------------------------
MT_FST_FILE <- "/path/to/workspace/poolseq/PPalign_output/fst_mt_noDloop_withNorway/mtgenome_noDloop_withNorway_fst.csv"
NU_FST_DIR  <- "/path/to/workspace/gene_fst_work_withNorway/fst_out_all_withNorway"

OUTDIR <- "/path/to/workspace/gene_fst_work_withNorway/pbs_mt_vs_nuclear_NorwayOutgroup_dropLB"
