...
INFILE <- "/path/to/workspace/ldx_all_subunits_withAMO_noLB_DP20/ld_pruned_R2_0.2/deltaAF_long.withAMO_noLB.ldPruned_kept.keepMarine.DP20.R2_0.2.tsv.gz"

GENE_LIST_FILE <- "/path/to/data/nu_287/q2_parallelism/oxphos72_genes.withAMO_noLB.list"

POOLINFO <- "/path/to/workspace/Poolinfo.csv"

CLUSTER_FILE <- "/path/to/data/nu_287/q2_parallelism/mtCluster_manual.tsv"

OUTDIR <- "/path/to/workspace/ldx_all_subunits_withAMO_noLB_DP20/ld_pruned_R2_0.2/geoLatLong_mtlineage_GLM_OXPHOS72"
